...
<div id="bottom_nav">
	<ul>
		...
		<li class="bot_cover"><a href="<?php echo home_url( '/' ); ?>">COVER STORIES <i class="fa fa-plus awe_font"></i></a></li>
		...
		<li class="bot_other"><a href="<?php echo home_url( '/' ); ?>other-projects">OTHER PROJECTS <i class="fa fa-plus awe_font"></i></a></li>
	</ul>
</div>
...
<footer role="contentinfo" id="footer">
	<div id="contact_box">
		<p class="contact_plus"><i class="fa fa-plus"></i></p>
		<div class="contact_name_box clearfix">
			...
			<p class="contact_things">415.514.4151</p>
